<x-app>
    ...
    <div class="flex bg-gray-100 text-gray-900">
        <aside class="flex h-screen w-20 flex-col items-center border-r border-gray-200 bg-white">
            ...
            <nav class="flex flex-1 flex-col gap-y-4 pt-10">
                <button  class="group relative rounded-xl bg-gray-100 p-2 text-blue-600 hover:bg-gray-50">
        ...
        <div class="w-full " >
            ...
            @foreach($todos as $todo)
                ...
                <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ml-5 mt-5">
                    ...
                    <button  id="editbutton"  data-modal-target="openmodal" data-modal-toggle="openmodal" class="inline-flex font-medium items-center text-blue-600 hover:underline" onclick="openMode({{$todo}})">
                        ...
                        <div class="p-4 md:p-5">
                            ...
                            <form class="space-y-4" wire:submit="save" >
                                <div>
                                    ...
                                    <input id="todoid" type="hidden" wire:model="todoid" name="todoid"   />
    ...
    <script>
        const openMode = (todo) => {
            ...
            document.getElementById('edit-form').textContent='Update'
            console.log(document.getElementById('todoid').value = todo.id);
        }
